...
function getTodayString() {
    return "<span style='color:#EE7973;font-size:24px;'>" + today.getFullYear() + "</span>年<span style='color:#EE7973;font-size:24px;'>" + (today.getMonth() + 1) + "</span>月<span style='color:#EE7973;font-size:24px;'>" + today.getDate() + "</span> 星期<span style='color:#EE7973;font-size:24px;'>" + weeks[today.getDay()] +"</span>";
}
